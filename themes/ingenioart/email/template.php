	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; font-family: 'Arial', sans-serif; border: 1px solid rgba(0,0,0,.4) ">
		...
		<tr>
			<td align="center" bgcolor="<?= $bg_header; ?>" style="padding: 20px 0 20px 0;">
				...
				<a href="http://www.ingenioart.com/" target="_blank" style="display:inline-block; border: 2px solid #ffffff;">

					<img src="http://www.ingenioart.com/wp-content/themes/ingenioart/images/logo.png" alt="Mail Template by Ingenioart - JGreen" width="295" height="77" style="display: block; background: white;" />
		...
		<tr>
			<td bgcolor="<?= $bg_body; ?>" style="padding: 40px 30px 40px 30px;"> 
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
					...
					<tr>
						<td>
							<h2> <?= $name_empresa; ?> - Agencia de Marketing Digital </h2>
						</td>
					</tr>					
					<tr>
